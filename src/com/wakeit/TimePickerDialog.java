...
public final class TimePickerDialog extends AlertDialog {
  ...
  public TimePickerDialog(Context context, String title, final boolean showSeconds,
    ...
    hourPicker.text.setEnabled(false);
    hourPicker.text.setTextColor(Color.WHITE);
    //hourPicker.text.setBackgroundColor(Color.WHITE);
    //hourPicker.text.setClickable(false);
    minutePicker.text.setEnabled(false);
    minutePicker.text.setTextColor(Color.WHITE);
    //minutePicker.text.setBackgroundColor(Color.WHITE);
    
    //minutePicker.text.setClickable(false);
    if (showSeconds) {
  ...
  private final class PickerView {
    ...
    public EditText text = null;//fuckkkkkkkkkkkkkkkkkkk
    private Increment increment = null;
    private Button incrementValueButton = null;
    private ImageButton plus = null;
    private ImageButton plus10 = null;
    private ImageButton minus = null;
    private ImageButton minus10 = null;
    ...
    public void inflate(View parentView, int resourceId, boolean showIncrement, IncrementValue defaultIncrement) {
      ...
      plus = (ImageButton) view.findViewById(R.id.time_plus);
      ...
      plus10 = (ImageButton) view.findViewById(R.id.time_plus10);
      TimeIncrementListener10 incrementListener10 = new TimeIncrementListener10();
      plus10.setOnClickListener(incrementListener10);
      plus10.setOnTouchListener(incrementListener10);
      plus10.setOnLongClickListener(incrementListener10);
      minus = (ImageButton) view.findViewById(R.id.time_minus);
      ...
      minus10 = (ImageButton) view.findViewById(R.id.time_minus10);
      TimeDecrementListener10 decrementListener10 = new TimeDecrementListener10();
      minus10.setOnClickListener(decrementListener10);
      minus10.setOnTouchListener(decrementListener10);
      minus10.setOnLongClickListener(decrementListener10);
    ...
    private final class TimeIncrementListener10 extends TimeAdjustListener {
        @Override
        protected int sign() {
          return 10;
        }
    ...
    private final class TimeDecrementListener10 extends TimeAdjustListener {
        @Override
        protected int sign() {
      	return -10;
        }
